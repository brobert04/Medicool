...
@include('medicool.frontend.partials.head')
...
<body>
  ...
  <!-- ======= Header ======= -->
    @include('medicool.frontend.partials.header')
  <!-- End Header -->
...
{{-- 
  ...
  <!-- ======= Footer ======= -->
  @include('medicool.frontend.partials.footer')
  <!-- End Footer -->
  ...
  <!-- JS Files -->
    @include('medicool.frontend.partials.scripts')
</body>
